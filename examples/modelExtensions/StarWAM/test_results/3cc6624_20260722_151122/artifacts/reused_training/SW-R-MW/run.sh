...
export ROBOTWIN_DATA=/data0/FastWAM-PERF-002-storage/root-migration-20260716T0311Z/repo-runs-performance-assets/robotwin2.0-fastwam/robotwin2.0
...
CASE_ID=SW-R-MW
RUN_ID=SW-R-MW_20260722_092000
CONFIG=examples/modelExtensions/StarWAM/train_files/robotwin_mot_wan22.yaml
OVERRIDES="[\"backbone.pretrained_model_id=${WAN22_ROOT}\",\"framework.action_expert_init_from=${WAN_ACTION_DIT_INIT}\",\"training.batch_size=4\",\"training.gradient_accumulation_steps=128\",\"data.dataset_dirs=['${ROBOTWIN_DATA}']\",\"data.text_embedding_cache_dir=${TEST_RUN_ROOT}/cache/${CASE_ID}\",\"data.action_stats_path=${TEST_RUN_ROOT}/stats/${CASE_ID}.json\",\"data.state_stats_path=${TEST_RUN_ROOT}/stats/${CASE_ID}.json\"]"
...
printf '%s\n' "4 * 2 * 128 = 1024" > "${TEST_RUN_ROOT}/manifest/${CASE_ID}/effective_global_batch.txt"
