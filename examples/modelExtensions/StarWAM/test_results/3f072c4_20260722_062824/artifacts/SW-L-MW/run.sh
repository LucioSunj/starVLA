...
export TEST_RUN_ROOT=/home/amax/data0/SJ/test-runs/starwam-integration/3f072c4_20260722_062824
...
CASE_ID=SW-L-MW
RUN_ID=SW-L-MW_20260722_063933
CONFIG=examples/modelExtensions/StarWAM/train_files/libero_mot_wan22.yaml
OVERRIDES="[\"backbone.pretrained_model_id=${WAN22_ROOT}\",\"framework.action_expert_init_from=${WAN_ACTION_DIT_INIT}\",\"training.batch_size=4\",\"training.gradient_accumulation_steps=16\",\"data.dataset_dirs=['${LIBERO_SPATIAL_DATA}','${LIBERO_OBJECT_DATA}','${LIBERO_GOAL_DATA}','${LIBERO_10_DATA}']\",\"data.text_embedding_cache_dir=${TEST_RUN_ROOT}/cache/${CASE_ID}\",\"data.action_stats_path=${TEST_RUN_ROOT}/stats/${CASE_ID}.json\",\"data.state_stats_path=${TEST_RUN_ROOT}/stats/${CASE_ID}.json\"]"
